...
public class CharacterRepo {
    ...
    public List<CharacterDto> findCharacterByAdventure(String adventure) {
        return selectQuery()
    ...
    private QBean<CharacterDto> selectFields() {
        return Projections.fields(CharacterDto.class,
                characterEntity.id,
                ...
                Projections.fields(CharacterItemDto.class,
                        ...
                        characterItemEntity.enchantSkillBonus).as("item"));
    }

    private QBean<CharacterDto> fullFields() {
        return Projections.fields(CharacterDto.class,
                characterEntity.id,
                characterEntity.name,
                characterEntity.level,
